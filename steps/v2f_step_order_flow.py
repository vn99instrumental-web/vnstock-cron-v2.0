...
Sync từ step_order_flow.py:
  ...
  2026-06-11 — v2 fork: input v2f_deep_raw.json / output v2f_order_flow.json
...
"""
# FORK V2F: đọc v2f_deep_raw.json → ghi v2f_order_flow.json. Universe đã do v2f_step_snapshot quyết định.
import os
import sys
...
if __name__ == "__main__":
    ...
    # ── V2: đọc v2f_deep_raw.json thay vì deep_raw.json ──
    ...
    # ── V2: ghi v2f_order_flow.json thay vì order_flow.json ──
    save_json("v2f_order_flow.json", results)
    log.info(
        f"Saved v2f_order_flow.json — {len(results)} symbols "
