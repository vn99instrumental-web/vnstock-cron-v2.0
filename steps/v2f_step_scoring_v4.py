...
# ── v4.18 (2026-09-17, GHI PRODUCTION theo yêu cầu owner — KHÔNG shadow) ─────
#   Tái cân bằng theo forward-IC THẬT (v4.1 n=896; v4.8/v4.9 n=400):
#   • mean_reversion — factor DƯƠNG mạnh & bền nhất (IC +0.14/+0.16 @3-5d) → 0.27→0.50
#   • breakout — IC ÂM bền (-0.24/-0.35), phản tác dụng → 0.1307→0.05
#   • flow — IC yếu/âm (~-0.05, trong nhiễu) → 0.2724→0.15
#   • fundamental (mixed, + ở 10d) 0.2179→0.20; growth (≈0) 0.109→0.10; context 0.
#   Mục tiêu: IC score_trade về dương như v4.1. Vẫn giữ shadow ĐỐI CHỨNG "MR-off".
# ── v4.8 (lịch sử) ─ MR bật lại 0.27 + gate MR=1.0 mọi regime.
_W_TRADE_V4 = {"mean_reversion": 0.50,   "breakout": 0.05, "flow": 0.15,
               "fundamental":    0.20,   "growth":   0.10, "context": 0.0}
